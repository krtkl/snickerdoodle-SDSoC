...
#
# snickerdoodle_black.tcl: Tcl script for re-creating project 'snickerdoodle_black'
#
# Generated by Vivado on Wed Feb 28 18:00:29 PST 2018
...
#
# 1. This project restoration tcl script (snickerdoodle_black.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "snickerdoodle-SDSoC/projects/snickerdoodle_black/snickerdoodle_black.srcs/sources_1/bd/base/hdl/base_wrapper.v"
#
...
set project_name "snickerdoodle_black"
...
set script_file "snickerdoodle_black.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/snickerdoodle_black"]"

# Create project
create_project ${project_name} ./${project_name} -part xc7z020clg400-3
...
set_property PFM_NAME "krtkl.com:snickerdoodle_black:snickerdoodle_black:1.0" [get_files base.bd ] 
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg400-3 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-3 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
